<?php 
	...
	$ruta = ($tabla == 'contenidos') ? $ruta = '../': $ruta = '';
	$titulo_seccion = ($tabla == 'contenidos') ? $titulo_seccion = 'HOME': $titulo_seccion = 'INICIO';
...
<html>
	...
	<body>
		...
		<div class="camIcon2">
			<img src="img/cam4.png"/>
		</div>
		
		<div class="cnt">
			<?php while ($contenido = mysqli_fetch_array($r_contenidos)): ?>
				<div class="cnt_entrada">
					<div class="tt_entrada gris">
						<?php echo $contenido['titulo']; ?>
					</div>
					
					<div class="cnt_img"><img src="cms/<?php echo $contenido['imagen3']; ?>" /></div>
					
					<p class="f_open grismedio just">
		...
		<?php 
			if (file_exists("requeridos/footer.php")) {
				include('requeridos/footer.php'); 
			}
		?>
	</body>
</html>
