<?php
	...
	function confirm_query($result_set){
		if(!$result_set){
			die("La busqueda en la Base de Datos fallo: " . mysqli_error($connection));
		}
	}
	...
	function traer_seccion_por_id($seccion_id){
		...
		if($seccion = mysqli_fetch_array($result_set)){
			return $seccion;
		}else{
			return NULL;
		}
	...
	function todas_las_publicaciones(){
		...
		$grupo_publicaciones = mysqli_query($connection, $query);
	...
	function traer_publicacion_por_id($publicacion_id){
		...
		if($contenido = mysqli_fetch_array($result_set)){
			return $contenido;
		}else{
			return NULL;
		}
	...
	function traer_imagenes_publicacion_por_id($id){
		...
		$grupo_imagenes = mysqli_query($connection, $query);
	...
	function todas_las_noticias(){
		...
		$grupo_noticias = mysqli_query($connection, $query);
	...
	*/
	...
	function traer_articulo_por_id($articulo_id){
		...
		if($articulo = mysqli_fetch_array($result_set)){
			return $articulo;
		}else{
			return NULL;
		}
	...
	function traer_imagenes_articulo_por_id($id){
		...
		$grupo_imagenes_articulo = mysqli_query($connection, $query);
	...
	function navegacion($seccion_seleccionada, $contenido_seleccionado){
		...
		while($seccion = mysqli_fetch_array($grupo_secciones)){
